...
For architecture guidance, concepts like `gameId` and player objects, and connection setup, see [Adding Support for a New Game](./adding-support-for-a-new-game).
